        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#"><img src="<?php echo base_url(); ?>assets/img/icone.png" style="width: 40px;">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="<?php echo site_url('backoffice/indexback'); ?>"><span>Accueil</span></a></li>
                            ...
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Nombres de menus</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>100</span></div>
                                        </div>
                                        <div class="col-auto"><img src="<?php echo base_url(); ?>assets/img/burger.png" style="height: 56px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Nombres de regimes</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>20</span></div>
                                        </div>
                                        <div class="col-auto"><img src="<?php echo base_url(); ?>assets/img/regime-alimentaire.png" style="height: 55px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-info py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Nombres de sport</span></div>
                                        ...
                                        <div class="col-auto"><img src="<?php echo base_url(); ?>assets/img/des-sports.png" style="height: 57px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span>Codes en attente</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>18</span></div>
                                        </div>
                                        <div class="col-auto"><img src="<?php echo base_url(); ?>assets/img/4090499.png" style="height: 59px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
