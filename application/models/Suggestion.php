...
class Suggestion extends CI_Model
{
    ...
    public function insert($data)
    {
        ...
        if ($this->db->affected_rows() > 0) {
            ...
            throw new Exception("Erreur de l'insertion de suggestion"); // Erreur lors de l'insertion
        }
    }
    ...
    public function update($data){
        ...
        if ($this->db->affected_rows() > 0) {
            ...
            throw new Exception("Erreur dans la modification de suggestion"); // Erreur lors de
        }
    }
    ...
    public function delete($id) {
        ...
        if ($this->db->affected_rows() > 0) {
            ...
            throw new Exception("Erreur dans la suppression de suggestion"); // Erreur lors de
        }
    }
