...
<head>
    ...
    <title>Ajouter un nouveau regime</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#"><img src="<?php echo base_url(); ?>assets/img/icone.png" style="width: 40px;">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?php echo site_url('backoffice/insert_regime'); ?>"><span>Inserer un nouveau regime</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Inserer un nouveau regime</h3>
                    <div class="row mb-3">
                        <div class="col-lg-8">
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">Inserer le nouveau regime</p>
                                        </div>
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Ajouter un menu&nbsp;</strong><br></label><select class="form-select">
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Ajouter un sport&nbsp;</strong><br></label><select class="form-select">
                                                                <optgroup label="This is a group">
                                                                    <option value="12" selected="">This is item 1</option>
                                                                    <option value="13">This is item 2</option>
                                                                    <option value="14">This is item 3</option>
                                                ...
                                                <div class="mb-3" style="margin-top: 17px;">
                                                    ...
                                                    <button class="btn btn-success btn-sm" type="submit" style="float: right; color: white;">Confirmer</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
