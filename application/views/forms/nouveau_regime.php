                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" action="<?php echo site_url('backoffice/ajouter_au_regime'); ?>">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Entrer la categorie du regime&nbsp;</strong><br></label><select class="form-select">
                                                ...
                                                <div class="mb-3" style="margin-top: 17px; float: right;"><button class="btn btn-primary btn-sm" type="submit">Suivant</button></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
